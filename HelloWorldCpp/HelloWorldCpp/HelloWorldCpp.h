...
namespace HelloWorldCpp {
	...
	/// <summary>
	/// Summary for HelloWorldCpp
	/// </summary>
	public ref class HelloWorldCpp : public System::Windows::Forms::Form
	{
	public:
		HelloWorldCpp(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &HelloWorldCpp::button1_Click);
			// 
			// HelloWorldCpp
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 12);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(318, 146);
			this->Controls->Add(this->button1);
			this->Name = L"HelloWorldCpp";
			this->Text = L"HelloWorldCpp";
